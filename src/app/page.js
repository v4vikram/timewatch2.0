      ...
      <section className="pt-0 lg:py-16 bg-white" >
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-secondary mb-2">Featured Products</h2>
            ...
            {[
              {
                ...
                description: "Advanced fingerprint, face, and iris recognition with 99.9% accuracy",
                color: "from-[#d63438] to-[#b82c30]"
              },
              {
                icon: Clock,
                title: "Real-time Tracking",
                description: "Live attendance monitoring with instant notifications and alerts",
                color: "from-[#6d6f72] to-[#5a5c5f]"
              },
              {
                icon: BarChart3,
                title: "Analytics Dashboard",
                description: "Comprehensive reports and insights for informed decision making",
                color: "from-[#d63438] to-[#b82c30]"
              },
              {
                icon: Users,
                title: "HRM Integration",
                description: "Seamless integration with payroll, leave management, and HR systems",
                color: "from-[#6d6f72] to-[#5a5c5f]"
              },
              {
                icon: Shield,
                title: "Security & Compliance",
                description: "Bank-grade security with GDPR compliance and data encryption",
                color: "from-[#d63438] to-[#b82c30]"
              },
              {
                icon: Globe,
                title: "Multi-location Support",
                description: "Centralized management across multiple offices and time zones",
                color: "from-[#6d6f72] to-[#5a5c5f]"
              }
            ].map((feature, index) => (
              <div key={index} className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-[#d63438]/20">
                <div className={`w-14 h-14 bg-gradient-to-br ${feature.color} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                  <feature.icon className="w-7 h-7 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-[#6d6f72] mb-3">{feature.title}</h3>
            ...
            {[
              {
                ...
                content: "TimeWatch transformed our attendance management. The biometric system eliminated time theft completely, saving us thousands monthly.",
                rating: 5
              },
              {
                name: "Michael Chen",
                ...
                content: "The integration with our existing HR system was seamless. Real-time reporting helps us make better workforce decisions.",
                rating: 5
              },
              {
                ...
                content: "Easy to deploy across multiple locations. The cloud-based dashboard gives us complete visibility into our workforce.",
                rating: 5
              }
              ...
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-[#d63438]">{testimonial.company}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-gradient-to-r from-[#d63438] to-[#b82c30]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join thousands of companies already using TimeWatch to streamline their operations
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#6d6f72] mb-2">Phone</h3>
                  <a href="tel:+91-95999 53923" className="text-gray-600">+91-95999 53923</a>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:011-4191-6615" className="text-gray-600">011-4191-6615</a>
                  {/* <p className="text-sm text-gray-500">Available 24/7 for support</p> */}
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#6d6f72] mb-2">Email</h3>
                  <a href="mailto:sales@timewatchindia.com" className="text-gray-600">sales@timewatchindia.com</a>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#6d6f72] mb-2">Address</h3>
