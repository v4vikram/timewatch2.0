  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 overflow-hidden">
        {/* Floating Elements */}
        <FloatingElement
          className="top-20 right-10 w-20 h-20 bg-white"
          delay={0}
        />
        <FloatingElement
          className="bottom-32 left-10 w-16 h-16 bg-yellow-400"
          delay={1}
        />
        <FloatingElement
          className="top-1/2 right-1/4 w-12 h-12 bg-pink-400"
          delay={2}
        />
        ...
        <div className="relative container mx-auto px-4 pt-20 pb-16">
          <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen">
            ...
            >
              {/* Badge */}
              <div className="inline-flex items-center bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-6 py-3 rounded-full text-sm font-semibold mb-6 animate-pulse">
                <Star className="w-4 h-4 mr-2" />
                🎉 2 Years FREE Cloud Access for 250 Users
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                <button className="group bg-gradient-to-r from-orange-500 to-red-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {payrollFeatures.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <Icon className="w-8 h-8 text-white" />
                  </div>
